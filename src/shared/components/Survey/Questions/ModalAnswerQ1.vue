...
export default class ModalAnswerQ1 extends Vue {
    public name: string = 'ModalAnswerQ1'
    ...
    get selectedText() {
        if (this.selectedAnswers.length === 2) {
            return questionDictionary.q1.subAnswers[this.selectedAnswers[1]]
        }
        return null
    }
